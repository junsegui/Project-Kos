...
export const ProductItem = () => {
  ...
  return (
    <Container>
      <WidthContainer>
      <ImageContainer><IMG src={findedItem.img}/></ImageContainer>
      <InfoContainer>
        <Back> back to  </Back>
        <TittlePrice>
        ...
        <Description>rounded vase is  a handmade with clay, inspired by the nordic nature and color tones. due to their handmade nature, each bowl is unque in shape and size.</Description>
        <AddAndButton>
          <AddAndRest>
          <But>-</But>
          <Numb>1</Numb>
